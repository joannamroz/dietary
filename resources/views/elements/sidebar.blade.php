...
<div class="scroll-wrapper scrollable scrollbar-macosx" style="position: relative;"><div class="scrollable scrollbar-macosx scroll-content scroll-scrollx_visible scroll-scrolly_visible" style="height: auto; margin-bottom: 0px; margin-right: 0px; max-height: 582px;">
  <div class="sidebar__cont">
    <div class="sidebar__menu active" style="margin-left: 0px;">
        ...
        <div class="ss-widget__cont">
          <div class="ss-widget__row">
            ...
            <div class="ss-widget__cell">
              <div class="bootstrap-switch bootstrap-switch-wrapper bootstrap-switch-on bootstrap-switch-micro bootstrap-switch-animate" style="width: 46px;"><div class="bootstrap-switch-container" style="width: 66px; margin-left: 0px;"><span class="bootstrap-switch-handle-on bootstrap-switch-success" style="width: 22px;">ON</span><span class="bootstrap-switch-label" style="width: 22px;">&nbsp;</span><span class="bootstrap-switch-handle-off bootstrap-switch-danger" style="width: 22px;">OFF</span><input type="checkbox" checked="checked" data-size="micro" data-on-color="success" data-off-color="danger" class="bs-switch"></div></div>
            </div>
          </div>
          <div class="ss-widget__row">
            <div class="ss-widget__cell">Mailing</div>
            <div class="ss-widget__cell">
              <div class="bootstrap-switch bootstrap-switch-wrapper bootstrap-switch-off bootstrap-switch-micro bootstrap-switch-animate" style="width: 46px;"><div class="bootstrap-switch-container" style="width: 66px; margin-left: -22px;"><span class="bootstrap-switch-handle-on bootstrap-switch-success" style="width: 22px;">ON</span><span class="bootstrap-switch-label" style="width: 22px;">&nbsp;</span><span class="bootstrap-switch-handle-off bootstrap-switch-danger" style="width: 22px;">OFF</span><input type="checkbox" data-size="micro" data-on-color="success" data-off-color="danger" class="bs-switch"></div></div>
            </div>
          </div>
          <div class="ss-widget__item">
            <div class="ss-widget__label">Limit</div>
            <div class="ss-widget__value">
              <span class="irs js-irs-0"><span class="irs"><span class="irs-line" tabindex="-1"><span class="irs-line-left"></span><span class="irs-line-mid"></span><span class="irs-line-right"></span></span><span class="irs-min" style="visibility: visible;">0</span><span class="irs-max" style="visibility: visible;">2 000</span><span class="irs-from" style="visibility: hidden;">0</span><span class="irs-to" style="visibility: hidden;">0</span><span class="irs-single" style="left: 23.8125%;">600</span></span><span class="irs-grid"></span><span class="irs-bar" style="left: 5.625%; width: 26.625%;"></span><span class="irs-bar-edge"></span><span class="irs-shadow shadow-single" style="display: none;"></span><span class="irs-slider single" style="left: 26.625%;"></span></span><input type="text" name="" value="" data-grid="false" data-min="0" data-max="2000" data-from="600" data-step="200" class="settings-slider irs-hidden-input" readonly="">
            </div>
          </div>
          <div class="ss-widget__row">
            <div class="ss-widget__cell">Timeout</div>
            <div class="ss-widget__cell">
              <div class="input-number-box"><input type="number" min="5" max="50" step="5" value="15" class="form-control input-sm" style="display: none;"><input class="input-number form-control input-sm" type="text" value="15" min="5" max="50" step="5"><div class="input-number-more"></div><div class="input-number-less"></div></div>
            </div>
          </div>
        </div>
      </div>
      <div class="sidestat">
        <div class="sidestat__cont">
          <div class="sidestat__item">
            ...
            <div class="sidestat__chart sparkline bar"><canvas width="154" height="30" style="display: inline-block; width: 154px; height: 30px; vertical-align: top;"></canvas></div>
          </div>
          <div class="sidestat__item">
            <div class="sidestat__value">2,034</div>
            <div class="sidestat__text">views of your products</div>
            <div class="sidestat__chart sparkline area"><canvas width="145" height="40" style="display: inline-block; width: 145px; height: 40px; vertical-align: top;"></canvas></div>
          </div>
          <div class="sidestat__item">
            <div class="sidestat__value">$2,950</div>
            <div class="sidestat__text">average day earning</div>
            <div class="sidestat__chart sparkline bar_thin"><canvas width="143" height="30" style="display: inline-block; width: 143px; height: 30px; vertical-align: top;"></canvas></div>
          </div>
          <div class="sidestat__item">
            <div class="sidestat__value">290</div>
            <div class="sidestat__text">month orders</div>
            <div class="sidestat__chart sparkline line"><canvas width="118" height="30" style="display: inline-block; width: 118px; height: 30px; vertical-align: top;"></canvas></div>
          </div>
        </div>
      </div>
    </div>
  </div>
</div><div class="scroll-element scroll-x scroll-scrollx_visible scroll-scrolly_visible"><div class="scroll-element_outer"><div class="scroll-element_size"></div><div class="scroll-element_track"></div><div class="scroll-bar" style="width: 17px; left: 0px;"></div></div></div><div class="scroll-element scroll-y scroll-scrollx_visible scroll-scrolly_visible"><div class="scroll-element_outer"><div class="scroll-element_size"></div><div class="scroll-element_track"></div><div class="scroll-bar" style="height: 444px; top: 0px;"></div></div></div></div>
</div>